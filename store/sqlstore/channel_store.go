...
var allChannelMembersForUserCache = cache.NewDefaultLRU(&cache.LRUOptions{
	Size: ALL_CHANNEL_MEMBERS_FOR_USER_CACHE_SIZE,
})
var allChannelMembersNotifyPropsForChannelCache = cache.NewDefaultLRU(&cache.LRUOptions{
	Size: ALL_CHANNEL_MEMBERS_NOTIFY_PROPS_FOR_CHANNEL_CACHE_SIZE,
})
var channelByNameCache = cache.NewDefaultLRU(&cache.LRUOptions{
